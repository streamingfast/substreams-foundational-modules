...
/** Lazy view of `protocol.BuyStorageBytesContract`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `BuyStorageBytesContractView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `BuyStorageBytesContractView`-family
 ...
 let view = BuyStorageBytesContractLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct BuyStorageBytesContractLazyView<'a> {
    /// Field 1: `owner_address`
    pub owner_address: &'a [u8],
    /// Field 2: `bytes`
    pub bytes: i64,
}
impl<'a> BuyStorageBytesContractLazyView<'a> {
...
impl<'a> ::buffa::LazyMessageView<'a> for BuyStorageBytesContractLazyView<'a> {
...
impl<'a> ::buffa::MessageName for BuyStorageBytesContractLazyView<'a> {
...
/** Lazy view of `protocol.BuyStorageContract`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `BuyStorageContractView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `BuyStorageContractView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = BuyStorageContractLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct BuyStorageContractLazyView<'a> {
    /// Field 1: `owner_address`
    pub owner_address: &'a [u8],
    /// Field 2: `quant`
    pub quant: i64,
}
impl<'a> BuyStorageContractLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for BuyStorageContractLazyView<'a> {
...
impl<'a> ::buffa::MessageName for BuyStorageContractLazyView<'a> {
    const PACKAGE: &'static str = "protocol";
...
/** Lazy view of `protocol.SellStorageContract`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `SellStorageContractView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `SellStorageContractView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = SellStorageContractLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct SellStorageContractLazyView<'a> {
    /// Field 1: `owner_address`
    pub owner_address: &'a [u8],
    /// Field 2: `storage_bytes`
    pub storage_bytes: i64,
}
impl<'a> SellStorageContractLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for SellStorageContractLazyView<'a> {
...
impl<'a> ::buffa::MessageName for SellStorageContractLazyView<'a> {
    const PACKAGE: &'static str = "protocol";
...
/** Lazy view of `protocol.UpdateBrokerageContract`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `UpdateBrokerageContractView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `UpdateBrokerageContractView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = UpdateBrokerageContractLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct UpdateBrokerageContractLazyView<'a> {
    /// Field 1: `owner_address`
    pub owner_address: &'a [u8],
    /// Field 2: `brokerage`
    pub brokerage: i32,
}
impl<'a> UpdateBrokerageContractLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for UpdateBrokerageContractLazyView<'a> {
...
impl<'a> ::buffa::MessageName for UpdateBrokerageContractLazyView<'a> {
    const PACKAGE: &'static str = "protocol";
