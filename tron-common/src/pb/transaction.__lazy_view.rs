...
/** Lazy view of `sf.substreams.tron.v1.Transactions`: nested and repeated message fields are
...
pub struct TransactionsLazyView<'a> {
    ...
    pub transactions: ::buffa::LazyRepeatedView<
        'a,
        super::super::super::super::super::tron::r#type::v1::__buffa::lazy_view::TransactionLazyView<
            'a,
        >,
    >,
    /// Field 2: `clock`
