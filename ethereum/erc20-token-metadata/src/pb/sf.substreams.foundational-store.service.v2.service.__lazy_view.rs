...
/** Lazy view of `sf.substreams.foundational_store.service.v2.FlushRequest`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `FlushRequestView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `FlushRequestView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = FlushRequestLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct FlushRequestLazyView<'a> {
    /// Field 2: `operations`
    pub operations: ::buffa::LazyMessageFieldView<
        'a,
        super::super::super::super::super::internal::v2::__buffa::lazy_view::OperationsLazyView<
            'a,
        >,
    >,
}
impl<'a> FlushRequestLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
        ...
        while !cur.is_empty() {
            ...
            match tag.field_number() {
                2u32 => {
                    ...
                    let sub = ::buffa::types::borrow_bytes(&mut cur)?;
                    ctx.register_element_memory(::core::mem::size_of::<&'a [u8]>())?;
                    view.operations.push_fragment(sub, __sub_ctx);
                }
                _ => {
                    ::buffa::encoding::skip_field_depth(tag, &mut cur, ctx.depth())?;
                }
...
impl<'a> ::buffa::LazyMessageView<'a> for FlushRequestLazyView<'a> {
    ...
    fn to_owned_message(
        ...
        ::core::result::Result::Ok(super::super::FlushRequest {
            operations: match self.operations.get()? {
                ::core::option::Option::Some(v) => {
                    ::buffa::MessageField::<
...
impl<'a> FlushRequestLazyView<'a> {
    ...
    pub fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        ...
        use ::buffa::ViewEncode as _;
        let mut size = 0u64;
        for __frag in self.operations.fragments() {
            size
                += 1u64 + ::buffa::encoding::varint_len(__frag.len() as u64) as u64
                    + __frag.len() as u64;
        }
...
impl<'a> ::buffa::MessageName for FlushRequestLazyView<'a> {
    const PACKAGE: &'static str = "sf.substreams.foundational_store.service.v2";
...
/** Lazy view of `sf.substreams.foundational_store.service.v2.FlushResponse`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `FlushResponseView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `FlushResponseView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = FlushResponseLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct FlushResponseLazyView<'a> {
    #[doc(hidden)]
    pub __buffa_phantom: ::core::marker::PhantomData<&'a ()>,
}
impl<'a> FlushResponseLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for FlushResponseLazyView<'a> {
...
impl<'a> ::buffa::MessageName for FlushResponseLazyView<'a> {
    const PACKAGE: &'static str = "sf.substreams.foundational_store.service.v2";
