...
/** Lazy view of `sf.substreams.solana.spl.v1.InitializedAccount`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `InitializedAccountView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `InitializedAccountView`-family
 ...
 let view = InitializedAccountLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct InitializedAccountLazyView<'a> {
    /// Field 1: `account`
    pub account: &'a str,
...
impl<'a> InitializedAccountLazyView<'a> {
...
impl<'a> ::buffa::LazyMessageView<'a> for InitializedAccountLazyView<'a> {
...
impl<'a> ::buffa::MessageName for InitializedAccountLazyView<'a> {
...
/** Lazy view of `sf.substreams.solana.spl.v1.AccountOwner`: nested and repeated message fields are
 recorded as undecoded byte ranges and decoded on access. See
 [`::buffa::LazyMessageView`] for the deferred-validation contract;
 the eager, whole-tree-validated counterpart is named `AccountOwnerView`.

 Oneof variants, map values, groups, and extern-typed fields (e.g.
 well-known types) hold eagerly-decoded `AccountOwnerView`-family
 types; only singular/repeated message fields defer.
 ...
 let view = AccountOwnerLazyView::decode_lazy(&bytes)?;
 ```*/
#[derive(Clone, Debug, Default)]
pub struct AccountOwnerLazyView<'a> {
    /// Field 2: `mint_address`
    pub mint_address: &'a [u8],
    /// Field 3: `owner`
    pub owner: &'a [u8],
}
impl<'a> AccountOwnerLazyView<'a> {
    /// Decode from `buf` under the limits carried by `ctx`, recording
    /// nested/repeated message fields as byte ranges.
    ///
    /// **Not part of the public API.**
...
impl<'a> ::buffa::LazyMessageView<'a> for AccountOwnerLazyView<'a> {
...
impl<'a> ::buffa::MessageName for AccountOwnerLazyView<'a> {
    const PACKAGE: &'static str = "sf.substreams.solana.spl.v1";
