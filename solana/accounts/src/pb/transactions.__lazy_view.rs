...
/** Lazy view of `sol.transactions.v1.Transactions`: nested and repeated message fields are
...
pub struct TransactionsLazyView<'a> {
    ...
    pub transactions: ::buffa::LazyRepeatedView<
        'a,
        super::super::super::super::super::sf::solana::r#type::v1::__buffa::lazy_view::ConfirmedTransactionLazyView<
            'a,
        >,
    >,
}
