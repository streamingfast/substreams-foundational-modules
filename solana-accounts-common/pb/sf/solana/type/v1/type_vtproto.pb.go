...
func (m *Accounts) CloneVT() *Accounts {
	if m == nil {
		return (*Accounts)(nil)
	}
	r := new(Accounts)
...
func (m *Accounts) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *AccountBlock) EqualVT(that *AccountBlock) bool {
	...
	if !this.Accounts.EqualVT(that.Accounts) {
		return false
	}
...
func (this *Accounts) EqualVT(that *Accounts) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *Accounts) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*Accounts)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *AccountBlock) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.Accounts != nil {
		size, err := m.Accounts.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Accounts) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Accounts) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Accounts) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AccountBlock) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.Accounts != nil {
		size, err := m.Accounts.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Accounts) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Accounts) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Accounts) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AccountBlock) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.Accounts.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Accounts) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AccountBlock) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.Accounts.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Accounts) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
