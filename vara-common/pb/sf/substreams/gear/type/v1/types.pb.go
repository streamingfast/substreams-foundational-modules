...
func (x *Fields) Reset() {
	*x = Fields{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sf_substreams_gear_type_v1_types_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Fields) Descriptor() ([]byte, []int) {
	return file_sf_substreams_gear_type_v1_types_proto_rawDescGZIP(), []int{7}
}
...
func (x *Array) Reset() {
	*x = Array{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sf_substreams_gear_type_v1_types_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Array) Descriptor() ([]byte, []int) {
	return file_sf_substreams_gear_type_v1_types_proto_rawDescGZIP(), []int{8}
}
...
var file_sf_substreams_gear_type_v1_types_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x61, 0x6d, 0x73, 0x2f, 0x67, 0x65, 0x61, 0x72, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2f,
...
var file_sf_substreams_gear_type_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
func file_sf_substreams_gear_type_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sf_substreams_gear_type_v1_types_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Fields); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sf_substreams_gear_type_v1_types_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Array); i {
			case 0:
				return &v.state
			case 1:
	...
	file_sf_substreams_gear_type_v1_types_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Value_Int32)(nil),
